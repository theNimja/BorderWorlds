...
i>=0;
i--)tag[i].style.visibility=h;
if ('hidden' === h) {tag=$('mbox').getElementsByTagName('input');
for(i=tag.length-1;
i>=0;
i--)tag[i].style.visibility='visible';
...
function sm(obl, wd, ht){var h='hidden';
var b='block';
var p='px';
var obol=$('ol');
 var obbxd = $('mbd');
...
function initmb(){var ab='absolute';
var n='none';
